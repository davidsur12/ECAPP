...
@Composable
fun ScreenGameOverLaberinto(navController: NavController){

    Scaffold{
        gameOverLaberinto(navController)
    }
}

@Composable
fun gameOverLaberinto(navController: NavController){
     DateUser.nivelLaberinto = 1
     DateUser.vidasLaberinto = 3
    BackHandler{
