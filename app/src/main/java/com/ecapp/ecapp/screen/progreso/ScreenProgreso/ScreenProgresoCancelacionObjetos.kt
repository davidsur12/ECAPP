...
@Composable
fun ScreenProgresoCancelacionObjetos(navController: NavController){


        progresoCancelacionObjetos(navController)
...
@Composable
fun progresoCancelacionObjetos(navController: NavController){
        ...
        content ={paddingValues ->
            Column(
                ...
                Box(
                    ...
                    Image(
                        painter = painterResource(id = com.ecapp.ecapp.R.drawable.cancelacion_2),
                ...
                Text("Resumen Semanal Cancelacion de Objetos",style = androidx.compose.ui.text.TextStyle(fontWeight = FontWeight.Bold, color = Color.White),
